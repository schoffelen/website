...
If you would like to read further about the FieldTrip function, you can continue with the [preprocessing](/tutorial/preproc/preprocessing) tutorial.
If you would like to have an introduction about scripting in MATLAB, it is suggested that you continue with the [scripting](/tutorial/scripting) tutorial.
If you are new to MATLAB or EEG/MEG analysis, you can take a look at the list of [review papers and teaching material](/references_to_review_papers_and_teaching_material).
